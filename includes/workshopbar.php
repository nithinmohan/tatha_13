...
$sub=1;
$flag='';
$query0=$mysqli->query("SELECT name,cat_id FROM event_cats WHERE par_cat='2'");
while($eventcategory=$query0->fetch_assoc())
{
	echo "<div class=\"menuitem\">";
	echo "<div class=\"wcolor\"></div>";
	echo "<div class=\"text\"><p>".$eventcategory['name']."</p></div>";
	if($sub>8) $flag='2';
	echo "<div class=\"submenuholder".$flag."\">";
	
	$query1=$mysqli->query("SELECT name,cat_id,shortdesc,validate FROM events WHERE cat_id=$eventcategory[cat_id] AND validate=2");
